...
// ID : 21CE120
// Write a program to create a default method in an 
interface IPrinter. Create 
// an interface IPrinter and IScanner. You can assume 
variables and methods 
// for both interfaces. Create a concrete class to 
implement both the 
// interfaces. Create 5 objects of the class, store it in 
Vector and display the 
...
Name: Savaliya Jaivin Pareshbhai ID no: 21CE120 
...
public class concrete { 
 ...
 { 
 Vector <temp> vt = new Vector<temp>(); // creating the 
